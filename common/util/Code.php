...
class Code
{
    ...
    static protected $errmsg = '' ;
    static protected $code ;
    static protected $function ;
    static protected $line ;

    public function __construct()
    {
        $this->errcodes = self::errCode() ;
    }

    public function setErr($code, $function='', $line='', $errmsg='')
    {
        self::$code         = $code ;
        self::$function     = $function ; //__FUNCTION__
        self::$line         = $line ;
        $hasCode            = isset($this->errcodes[$code]) ;
        if ($hasCode) {
            self::$errmsg       = $this->errcodes[$code] ;
        } else {
            self::$errmsg       = $this->errcodes[10008] ;
            if ($errmsg) {
                self::$errmsg   .= $errmsg ;
            }
        }
    ...
    {
        return self::$code .':['.self::$errmsg . ']==>'.self::$function .'--' . self::$line ;
    }

    public static function getMsg($code)
    {
        $arrMsg             = self::errCode() ;
        return isset($arrMsg[$code]) ? $arrMsg[$code] : '未知错误!' ;
    }
    ...
    protected static function errCode()
    {
        return [
            ...
            '10000' => '未知错误',
            '10001' => '您未登记，请登记后使用',
            '10002' => 'DeviceId Error!',
            '10003' => '存入数据库出问题!',
            '10004' => '员工编号有误请重试!',
            '10005' => 'MEMCACHE清空缓存失败!',
            '10006' => '成员列表存入缓存失败!',
            '10007' => '成员信息批量入缓存',
            '10008' => '无此错误编码',
            '30009' => 'YOUR CODE IS FORBIDEN',
