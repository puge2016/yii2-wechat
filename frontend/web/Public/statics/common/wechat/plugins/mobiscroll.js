...
function mobiscrollSelectInit(){
	var $mobiscrollWrap = $('.mobiscroll-wrap'),
	    $mobiscrollSelectWrap = $('.mobiscroll-select-wrap').not('.no-cover');
	$.each($mobiscrollWrap,function(i,e){
	    var $dd =  $(e).children('dd');
	    if(!$dd.children('div').length){
	        $dd.append('<div></div>');
	    };
	    if(!$dd.children('em').length){
	        $dd.append('<em></em>');
	    };
	    $dd.find('input').attr('readonly','readonly');
	});
	$.each($mobiscrollSelectWrap,function(i,e){
	    //$(e).children('dd').append('<em></em>');
	    var $dd =  $(e).children('dd');
	    if(!$dd.children('div').length){
	        $dd.append('<div></div>');
	    };
	    ...
	    //$dd.append('<div></div>').append('<em></em>');
	    $dd.find('input').attr('readonly','readonly');
	});
	var _divs = $mobiscrollWrap.find('dd > div'),
	    _divs_ = $mobiscrollSelectWrap.find('dd > div');
	_divs.on('click',function(){
	    $(this).parents('dd').children('input').trigger('click');
	});
	_divs_.on('click',function(){
	    $(this).parents('dd').children('input').trigger('click');
	});
};
mobiscrollSelectInit();
...
$(function(){
    window.mobiScrollInit = function(){
    var $normalSelect = $('.normal-select'),
        $date = new Date(),
        y = $date.getFullYear(),
        m = $date.getMonth(),
        d = $date.getDate();
    //普通select渲染
    $.each($normalSelect,function(i,e){
		...
		var $dateInput = $('.date-select'),
	        $dateTime = $('.datetime-select'),
	        $time = $('.time-select'),
	        $monthSelect = $('.month-select'),
	        $yearSelect = $('.year-select');
	    //日期选择器，不包含具体时间 
	    $.each($dateInput,function(i,e){
	        var min = $(e).data('min')?$(e).data('min').split(','):'',
	            max = $(e).data('max')?$(e).data('max').split(','):'',
	        ...
	        if(!min&&!max){ 
	            $(e).mobiscroll().date({
	                ...
	                /*formatValue:function(data){
	                    console.info(1,data);
	                    var newM = data[1]*1+1,
	                        m = newM<10?('0'+newM):newM;
	                        d = data[2]<10?('0'+data[2]):data[2];
	                    $(e).data('date',data[0]+'-'+m+'-'+d);
	                    return (parseInt(data[1])+1)+'月'+data[2]+'日';   
	                },*/
	                onSelect:function(data,val){
	                    $(e).attr('data-val',val._wheelArray[0]+'-'+(1+val._wheelArray[1]*1)+'-'+val._wheelArray[2]);
	                    $(e).attr('data-link',val._wheelArray[0]+','+(1+val._wheelArray[1]*1)+','+val._wheelArray[2]);
	                    if(callBack){
	                        window[callBack](e);
	                    };
	                }
	        ...
	        if(min&&!max){
	            $(e).mobiscroll().date({
	                ...
	                mode: 'mixed',        
	                display: 'bottom', 
	                minDate : new Date(min[0],min[1]*1-1,min[2]),
	        ...
	        if(!min&&max){ 
	            $(e).mobiscroll().date({
	                ...
	                mode: 'mixed',        
	                display: 'bottom', 
	                //minDate : new Date($(e).data('min')),
	                maxDate : new Date(max[0],max[1]*1-1,max[2]),
	                dateFormat:'yy年mm月dd日DD',
	                lang: 'zh',
	                /*formatValue:function(data){
	                    console.info(data);
	    ...
	    $.each($dateTime,function(i,e){
	        ...
	        if(!min&&!max){ 
	            $(e).mobiscroll().datetime({
	                ...
	                onSelect : function(data,val){
	                    $(e).attr('data-val',val._wheelArray[0]+'-'+(1+val._wheelArray[1]*1)+'-'+val._wheelArray[2]+' '+val._wheelArray[3]+':'+val._wheelArray[4]);
	                    
	                     						$(e).attr('data-link',val._wheelArray[0]+','+(1+val._wheelArray[1]*1)+','+val._wheelArray[2]+','+val._wheelArray[3]+','+val._wheelArray[4]);
	                    if(callBack){
	                        window[callBack](e);
	                    };
	                }
	        ...
	        if(min&&!max){ 
	            $(e).mobiscroll().datetime({
	                ...
	                mode: 'mixed',        
	                display: 'bottom', 
	                minDate : new Date(min[0],min[1]*1-1,min[2],min[3],min[4]),
	                dateFormat:'yy年mm月dd日DD',
	                timeFormat: 'HH:ii A',
	                lang: 'zh',
	                stepMinute: 1,
	        ...
	        if(!min&&max){ 
	            $(e).mobiscroll().datetime({
	                ...
	                mode: 'mixed',        
	                display: 'bottom', 
	                maxDate : new Date(max[0],max[1]*1-1,max[2],max[3],max[4]),
	                dateFormat:'yy年mm月dd日DD',
	                timeFormat: 'HH:ii A',
	                lang: 'zh',
	                stepMinute: 1,
	    ...
	    $.each($time,function(i,e){
	        ...
	        $(e).mobiscroll().time({
	            ...
	            lang: 'zh',
	            onSelect : function(data,val){
	                $(e).attr('data-val',val._wheelArray[0]+'-'+(val._wheelArray[1]*1+1));
	                $(e).attr('data-link',val._wheelArray[0]+','+(val._wheelArray[1]*1+1));
	                if(callBack){
	                    window[callBack](e);
	                };
	            }
	    ...
	    //日期选择器，只选月份
	    $.each($monthSelect,function(i,e){
	        var callBack = $(e).data('callback'),
                yearStr =  $.trim($(e).data('yearstr'));
            if(yearStr){
	        ...
	        $(e).mobiscroll({
	            ...
	            wheels: [
	                [
	                    { 
	                        values: yearStr || [2014,2015,2016,2017,2018,2019,2020]
	                    }
	                ],
	                [
	                    { 
	            ...
	            formatValue:function(data){
	                //console.info(data);
	                return (parseInt(data[0]))+'年'+data[1]+'月';
	            },
	            onSelect : function(data,val){
	                $(e).attr('data-val',val._wheelArray[0]+'-'+(val._wheelArray[1]*1));
	                $(e).attr('data-link',val._wheelArray[0]+','+(val._wheelArray[1]*1));
	                if(callBack){
	                    window[callBack](e);
	                };
	            }
	    ...
	    $.each($yearSelect,function(i,e){
	        ...
	        $(e).mobiscroll({
	            ...
	            formatValue:function(data){
	                //console.info(data);
	                return (parseInt(data[0]))+'年';
	            },
	            onSelect : function(data,val){
	                $(e).attr('data-val',val._wheelArray[0]);
	                $(e).attr('data-link',val._wheelArray[0]);
	                if(callBack){
	                    window[callBack](e);
	                };
	            }
