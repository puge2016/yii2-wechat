 ...
 */
class DepCopy extends ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function addAll($datas)
    {
        ...
        if (!$isEmpty && $isArray) {
            $filed          = array_keys($datas) ;
            $result         = Yii::$app->getDb()->createCommand()->batchInsert(self::tableName(), $filed, $datas)->execute();
            return $result ;
        } else {
            return false ;
        }
    ...
    /**
     * @inheritdoc
     * @return DepCopyQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new DepCopyQuery(get_called_class());
    }
}
