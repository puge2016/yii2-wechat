...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@backend/modules/admin/views/layouts/main0.php';
    ...
    public function init()
    {
        ...
        if (Yii::$app->user->isGuest) {
            ...
            $isUserLogin            = strpos($requestedRoute, 'user/login') ;
            $isUserSignup           = strpos($requestedRoute, 'user/signup') ;
            if ($isUserLogin === false && $isUserSignup === false ) {
                Yii::$app->response->redirect(['admin/user/login']) ;
                Yii::$app->end();
            }
        }
